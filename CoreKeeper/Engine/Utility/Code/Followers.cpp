...
CFollow* CFollow::Create(LPDIRECT3DDEVICE9 pGraphicDev, D3DXVECTOR3* origin, _int numParticles, _int iMaxTexture)
{
	CFollow* pInstance = new CFollow(pGraphicDev);

	if (FAILED(pInstance->Ready_Particles(origin, numParticles, iMaxTexture)))
	{
