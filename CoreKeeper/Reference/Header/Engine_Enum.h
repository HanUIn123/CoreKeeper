...
namespace Engine
{
    ...
    enum RENDERID { RENDER_PRIORITY, RENDER_NONALPHA, RENDER_ALPHA, RENDER_UI, RENDER_UIALPHA, RENDER_WINDOW, RENDER_END };
    ...
    enum MONSTERTYPE { MON_SLIME, MON_SHROOMMAN, MON_SHAMAN, MON_PROJECTILE, MON_END };
