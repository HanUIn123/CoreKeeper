...
void CAzeosSpawnPoint::SetUp_Light()
{
    D3DLIGHT9 light;
    ZeroMemory(&light, sizeof(D3DLIGHT9));

    light.Type = D3DLIGHT_SPOT;
    light.Diffuse = { 5.f, 5.f, 5.f, 1.f }; // 확산 색상
    light.Specular = { 5.f, 5.f, 5.f, 1.f }; // 반사 색상
    light.Ambient = { 5.f, 5.f, 5.f, 1.f }; // 주변광
    ...
    light.Phi = D3DXToRadian(120.0f); // 외부 각도 (큰 값일수록 퍼지는 조명)
