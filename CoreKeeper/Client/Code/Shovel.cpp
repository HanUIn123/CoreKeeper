...
CShovel::CShovel(LPDIRECT3DDEVICE9 pGraphicDev)
	: CItem(pGraphicDev)
{
...
HRESULT CShovel::Ready_GameObject(_vec3 vPos)
{
...
_int CShovel::Update_GameObject(const _float& fTimeDelta)
{
...
void CShovel::LateUpdate_GameObject()
{
	Engine::CGameObject::LateUpdate_GameObject();
}

void CShovel::Render_GameObject()
{
...
HRESULT CShovel::Add_Component()
{
	...
	pComponent = m_pTextureCom = dynamic_cast<CTexture*>(Engine::Clone_Proto(L"Proto_ShovelTex"));
	NULL_CHECK_RETURN(pComponent, E_FAIL);
...
CShovel* CShovel::Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vPos)
{
	CShovel* pSword = new CShovel(pGraphicDev);
