...
_int CWateringCan::Update_GameObject(const _float& fTimeDelta)
{
...
void CWateringCan::LateUpdate_GameObject()
{
	Engine::CGameObject::LateUpdate_GameObject();
}

void CWateringCan::Render_GameObject()
{
...
HRESULT CWateringCan::Add_Component()
{
	...
	pComponent = m_pTextureCom = dynamic_cast<CTexture*>(Engine::Clone_Proto(L"Proto_WateringCanTexture"));
	NULL_CHECK_RETURN(pComponent, E_FAIL);
