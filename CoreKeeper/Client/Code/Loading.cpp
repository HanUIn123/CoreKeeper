...
_uint CLoading::Loading_Stage()
{
    ...
    FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_BossHeal", Engine::CHeal::Create(m_pGraphicDev, &vPPos, 5, true)), E_FAIL);
...
#pragma region Item TEXTURE
    ...
    FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_BoxTexture", Engine::CTexture::Create(m_pGraphicDev, L"../Bin/Resource/Texture/Item/Box_%d.png", TEX_NORMAL, 2)), E_FAIL);
...
#pragma region UI TEXTURE
    ...
    FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_UIHealthTex", Engine::CTexture::Create(m_pGraphicDev, L"../Bin/Resource/Texture/UI/UI_Health_%d.png", TEX_NORMAL, 11)), E_FAIL);
    ...
    FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_UIBuffFrame", Engine::CTexture::Create(m_pGraphicDev, L"../Bin/Resource/Texture/UI/126x32_itemui_border_0.png", TEX_NORMAL)), E_FAIL);
    ...
    FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_UIPlayerCraftItem", Engine::CTexture::Create(m_pGraphicDev, L"../Bin/Resource/Texture/UI/Craft_Item/Craft_Item_%d.png", TEX_NORMAL, 50)), E_FAIL);
...
#pragma region Collider
    ...
    FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_SpawnPointCollider", Engine::CColliderCube::Create(m_pGraphicDev, _vec3(-0.5f, -0.5f, -0.5f), _vec3(0.5f, 0.5f, 0.5f))), E_FAIL);
    FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_MaluSpawnerCollider", Engine::CColliderCube::Create(m_pGraphicDev, _vec3(-0.5f, -0.5f, -0.5f), _vec3(0.5f, 0.5f, 0.5f))), E_FAIL);
