...
#pragma region Collider
    ...
    FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_AzeosSpawnPointCollider", Engine::CColliderCube::Create(m_pGraphicDev, _vec3(-0.5f, -0.5f, -0.5f), _vec3(0.5f, 0.5f, 0.5f))), E_FAIL);
