...
#pragma region Object TEXTURE
    ...
    FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_StatueBaseTexture", Engine::CTexture::Create(m_pGraphicDev, L"../Bin/Resource/Texture/BaseCamp/StatueBase_%d.png", TEX_NORMAL, 3)), E_FAIL);
