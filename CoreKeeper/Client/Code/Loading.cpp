...
#pragma region Collider
    ...
    FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_ShootCubeCollider", Engine::CColliderCube::Create(m_pGraphicDev, _vec3(-1.2f, -1.2f, -1.2f), _vec3(1.2f, 1.2f, 1.2f))), E_FAIL);
