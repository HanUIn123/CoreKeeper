...
_uint CLoading::Loading_Stage()
{
    ...
    // Object Tex
    FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_ObjectTex", Engine::CObjectTex::Create(m_pGraphicDev, 5, 0, 5, true)), E_FAIL);
    ...
    FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_SpawnCamp", Engine::CTexture::Create(m_pGraphicDev, L"../Bin/Resource/Texture/BaseCamp/Spawn.png", TEX_OBJECT)), E_FAIL);
    ...
    FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_StaffTex", Engine::CTexture::Create(m_pGraphicDev, L"../Bin/Resource/Texture/Item/Fireball_staff.png", TEX_NORMAL)), E_FAIL);
    ...
    FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_WallCollider", Engine::CColliderCube::Create(m_pGraphicDev, _vec3(-0.5f, -2.5f, -0.5f), _vec3(0.5f, 2.5f, 0.5f))), E_FAIL);
