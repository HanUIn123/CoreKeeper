...
_uint CLoading::Loading_Stage()
{
    ...
    FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_SwordCubeCollider", Engine::CColliderCube::Create(m_pGraphicDev, _vec3(-0.5f, -0.5f, -0.5f), _vec3(0.5f, 1.0f, 0.5f))), E_FAIL);
