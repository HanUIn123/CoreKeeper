...
CAccessoryTableObject::~CAccessoryTableObject()
{
}

HRESULT CAccessoryTableObject::Ready_GameObject(_vec3 vPos)
{
...
void CAccessoryTableObject::Render_GameObject()
{
...
CAccessoryTableObject* CAccessoryTableObject::Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vPos)
{
	CAccessoryTableObject* pCore = new CAccessoryTableObject(pGraphicDev);
...
void CAccessoryTableObject::Free()
{
