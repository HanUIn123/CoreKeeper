#include "pch.h"
#include "..\Header\LarvaCore.h"
#include "Export_System.h"
#include "Export_Utility.h"

CLarvaCore::CLarvaCore(LPDIRECT3DDEVICE9 pGraphicDev)
	: CItem(pGraphicDev)
{
	 

	m_eItemNum = ITEM_LARVA_CORE;
}

CLarvaCore::~CLarvaCore()
{
}

HRESULT CLarvaCore::Ready_GameObject(_vec3 vPos)
{
...
_int CLarvaCore::Update_GameObject(const _float& fTimeDelta)
{
...
void CLarvaCore::LateUpdate_GameObject()
{
	Engine::CGameObject::LateUpdate_GameObject();
}

void CLarvaCore::Render_GameObject()
{
...
HRESULT CLarvaCore::Add_Component()
{
...
CLarvaCore* CLarvaCore::Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vPos)
{
	CLarvaCore* pLarvaCore = new CLarvaCore(pGraphicDev);

	if (FAILED(pLarvaCore->Ready_GameObject(vPos)))
	{
		Safe_Release(pLarvaCore);
		MSG_BOX("pLarvaCore Create Failed");
		return nullptr;
	}
