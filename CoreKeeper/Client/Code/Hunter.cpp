...
void CHunter::Pattern_Idle(const _float& fTimeDelta)
{
    ...
    case HUNTER_GOTOBUSH:
        ...
        {
        case FRONT:
            m_pAnimatorCom->Set_CurState(IDLE, 32, 33, 8);
            break;
        case RIGHT:
        case LEFT:
            m_pAnimatorCom->Set_CurState(IDLE, 48, 49, 8);
            break;
        case BACK:
            m_pAnimatorCom->Set_CurState(IDLE, 64, 65, 8);
            break;
        }
        break;
    case HUNTER_LEAVEBUSH:
        ...
        {
        case FRONT:
            m_pAnimatorCom->Set_CurState(IDLE, 80, 81, 8);
            break;
        case RIGHT:
        case LEFT:
            m_pAnimatorCom->Set_CurState(IDLE, 96, 97, 8);
            break;
        case BACK:
            m_pAnimatorCom->Set_CurState(IDLE, 112, 113, 8);
            break;
        }
        break;
    case HUNTER_IDLE:
...
void CHunter::Pattern_Chase(const _float& fTimeDelta)
{
    ...
    if (!m_iChaseType)
    {
        ...
        {
        case FRONT:
            m_pAnimatorCom->Set_CurState(IDLE, 80, 81, 4);
            break;
        case RIGHT:
        case LEFT:
            m_pAnimatorCom->Set_CurState(IDLE, 96, 97, 4);
            break;
        case BACK:
            m_pAnimatorCom->Set_CurState(IDLE, 112, 113, 4);
            break;
        }
        // 은신 해제 다하면 추격 설정
        if (m_pAnimatorCom->Get_MotionEnd())
