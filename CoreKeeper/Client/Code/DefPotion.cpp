#include "pch.h"
#include "..\Header\DefPotion.h"
#include "Export_System.h"
#include "Export_Utility.h"

CDefPotion::CDefPotion(LPDIRECT3DDEVICE9 pGraphicDev)
	: CItem(pGraphicDev)
{
	m_eItemNum = ITEM_POTION_DEF;

	m_tStat.iDefense = 10;

}

CDefPotion::~CDefPotion()
{
}

HRESULT CDefPotion::Ready_GameObject(_vec3 vPos)
{
...
_int CDefPotion::Update_GameObject(const _float& fTimeDelta)
{
...
void CDefPotion::LateUpdate_GameObject()
{
	Engine::CGameObject::LateUpdate_GameObject();
}

void CDefPotion::Render_GameObject()
{
...
HRESULT CDefPotion::Add_Component()
{
...
CDefPotion* CDefPotion::Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vPos)
{
	CDefPotion* pDefPotion = new CDefPotion(pGraphicDev);

	if (FAILED(pDefPotion->Ready_GameObject(vPos)))
	{
		Safe_Release(pDefPotion);
		MSG_BOX("pDefPotion Create Failed");
		return nullptr;
	}
