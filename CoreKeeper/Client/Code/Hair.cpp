...
CHair::CHair(LPDIRECT3DDEVICE9 pGraphicDev) : Engine::CGameObject(pGraphicDev)
{
}
...
void CHair::Follow_Player()
{
	...
	if (playerTransform)
	{
		...
		else
		{
			...
			m_pTransformCom->Set_Pos(vPlayerPos.x, vPlayerPos.y - 0.04f, vPlayerPos.z - vPlayerLook.z * 0.02f);
