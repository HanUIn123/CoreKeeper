#include "pch.h"
#include "..\Header\MalCore.h"
#include "Export_System.h"
#include "Export_Utility.h"

CMalCore::CMalCore(LPDIRECT3DDEVICE9 pGraphicDev)
	: CItem(pGraphicDev)
{
	 

	m_eItemNum = ITEM_MAL_CORE;
}
...
HRESULT CMalCore::Ready_GameObject(_vec3 vPos)
{
...
_int CMalCore::Update_GameObject(const _float& fTimeDelta)
{
...
void CMalCore::LateUpdate_GameObject()
{
...
HRESULT CMalCore::Add_Component()
{
...
CMalCore* CMalCore::Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vPos)
{
	CMalCore* pMalCore = new CMalCore(pGraphicDev);

	if (FAILED(pMalCore->Ready_GameObject(vPos)))
	{
		Safe_Release(pMalCore);
		MSG_BOX("pMalCore Create Failed");
		return nullptr;
	}
