...
HRESULT CHelmet::Ready_GameObject()
{
...
_int CHelmet::Update_GameObject(const _float& fTimeDelta)
{
...
void CHelmet::LateUpdate_GameObject()
{
	Engine::CGameObject::LateUpdate_GameObject();
}

void CHelmet::Render_GameObject()
{
...
HRESULT CHelmet::Add_Component()
{
	...
	pComponent = m_pTextureCom = dynamic_cast<CTexture*>(Engine::Clone_Proto(L"Proto_HelmetTex"));
	NULL_CHECK_RETURN(pComponent, E_FAIL);
...
CHelmet* CHelmet::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
