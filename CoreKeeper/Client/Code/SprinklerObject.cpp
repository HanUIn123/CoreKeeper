...
HRESULT CSprinklerObject::Ready_GameObject(_vec3 vPos)
{
	...
	m_pWaterCom->init(L"../Bin/Resource/Texture/Particle/Water_Particle.png", 1.f, 0.1f);
	m_pWaterCom2->init(L"../Bin/Resource/Texture/Particle/Water_Particle.png", 1.f, 0.1f);
