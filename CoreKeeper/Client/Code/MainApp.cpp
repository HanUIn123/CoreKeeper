...
HRESULT CMainApp::SetUp_DefaultSetting(LPDIRECT3DDEVICE9* ppGraphicDev)
{
	...
	FAILED_CHECK_RETURN(Engine::Ready_Font(*ppGraphicDev, L"Font_Item", L"Galmuri9 Regular", 18, 18, FW_ULTRABOLD), E_FAIL);//Item용
	FAILED_CHECK_RETURN(Engine::Ready_Font(*ppGraphicDev, L"Font_Status", L"Galmuri9 Regular", 18, 18, FW_NORMAL), E_FAIL);//Stat용
