...
CPotionTableObject::CPotionTableObject(LPDIRECT3DDEVICE9 pGraphicDev)
	: CObject(pGraphicDev), m_bHandCollision(false)
{
}

CPotionTableObject::~CPotionTableObject()
{
}

HRESULT CPotionTableObject::Ready_GameObject(_vec3 vPos)
{
...
void CPotionTableObject::Render_GameObject()
{
...
CPotionTableObject* CPotionTableObject::Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vPos)
{
	CPotionTableObject* pCore = new CPotionTableObject(pGraphicDev);
