...
CHairShade::~CHairShade()
{
}

HRESULT CHairShade::Ready_GameObject()
{
...
_int CHairShade::Update_GameObject(const _float& fTimeDelta)
{
	Follow_Player();
...
void CHairShade::LateUpdate_GameObject()
{
	Engine::CGameObject::LateUpdate_GameObject();
}

void CHairShade::Render_GameObject()
{
...
HRESULT CHairShade::Add_Component()
{
	...
	pComponent = m_pTextureCom = dynamic_cast<CTexture*>(Engine::Clone_Proto(L"Proto_PlayerTex_HairShade"));
	NULL_CHECK_RETURN(pComponent, E_FAIL);
...
HRESULT CHairShade::Setup_Material()
{
	D3DMATERIAL9		tMtrl;
...
CHairShade* CHairShade::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CHairShade* pHairShade = new CHairShade(pGraphicDev);

	if (FAILED(pHairShade->Ready_GameObject()))
	{
		Safe_Release(pHairShade);
		MSG_BOX("pHairShade Create Failed");
		return nullptr;
	}
