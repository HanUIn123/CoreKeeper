...
class CAccessoryTableObject : public CObject
{
private:
	explicit						CAccessoryTableObject(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual							~CAccessoryTableObject();
public:
...
public:
	static CAccessoryTableObject* Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vPos);
