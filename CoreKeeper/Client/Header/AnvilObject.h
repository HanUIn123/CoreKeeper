...
class CAnvilObject : public CObject
{
private:
	explicit						CAnvilObject(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual							~CAnvilObject();
public:
...
public:
	static CAnvilObject* Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vPos, MATERIAL _eMaterial);
